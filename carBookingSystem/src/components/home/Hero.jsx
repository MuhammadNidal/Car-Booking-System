...
const HeroSection = () => {
  ...
  return (
    // FIX 1: Removed `overflow-hidden` from this main container.
    // This allows the absolute-positioned dropdowns to show outside
    // the bounds of the hero section without being clipped.
    <div className="h-dvh lg:h-[110vh] w-screen left-0 relative bg-gray-900">
      h
