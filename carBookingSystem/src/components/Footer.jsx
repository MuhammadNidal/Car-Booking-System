...
const Footer = () => (
  <footer className="bg-surface border-t border-gray-200 mt-12">
    <div className="container mx-auto px-4 md:px-8 lg:px-20 py-12 grid grid-cols-1 md:grid-cols-3 gap-6">
      <div>
        ...
        <p className="text-sm text-muted mt-2">Trusted car marketplace — buy, sell and service with confidence.</p>
      </div>
  ...
  <p className="text-sm text-muted mb-3">Subscribe for updates and offers.</p>
    ...
    <div className="border-t border-gray-100">
      <div className="container mx-auto px-4 md:px-8 lg:px-20 py-4 text-sm text-muted flex items-center justify-between">
        <div>© {new Date().getFullYear()} CarShowroom. All rights reserved.</div>
        <div className="flex items-center gap-4">
          <a href="#" className="text-muted hover:text-primary">Terms</a>
          <a href="#" className="text-muted hover:text-primary">Privacy</a>
        </div>
      </div>
    </div>
  </footer>
